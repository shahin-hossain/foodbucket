...
const Login = () => {
    return (
        <div className='max-w-7xl flex justify-center mt-10 items-center mx-auto'>
            <div className='w-full md:w-96 flex flex-col gap-4 border-2 rounded-lg p-10 shadow-2xl'>
                ...
                <Link className='list-none text-1xl py-3 px-3 text-center  bg-pink-600 rounded-lg font-semibold text-white' to="/">Log in</Link>
                <Link className='list-none text-1xl py-3 px-3 text-center border border-pink-600 rounded-lg font-semibold text-pink-600' to="/signup">Sign up</Link>
